...
/**
 * Modern UI Components Library Premium dark theme components with rounded
 * corners, animations, and consistent styling
 */
public class ModernUI {
    ...
    // ==================== GLOW BORDER ====================
    public static class GlowBorder extends AbstractBorder {

        private Color color;
        private int thickness;
        private int radius;

        public GlowBorder(Color color, int thickness, int radius) {
            this.color = color;
            this.thickness = thickness;
            this.radius = radius;
        }
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
            ...
            for (int i = 1; i <= thickness; i++) {
                float alpha = (float) (thickness - i) / (thickness * 2); // Fade out
                g2.setColor(new Color(color.getRed(), color.getGreen(), color.getBlue(), (int) (alpha * 255)));
                g2.setStroke(new BasicStroke(i));
                g2.draw(new RoundRectangle2D.Float(x + i / 2.0f, y + i / 2.0f, width - i, height - i, radius, radius));
            }
            g2.dispose();
        }
    ...
    // ==================== WINDOW UTILS ====================
    public static void makeDraggable(JFrame frame, JComponent grip) {
        ...
        grip.addMouseListener(ma);
        grip.addMouseMotionListener(ma);
    }
